...
export default function DocumentPage(props){
    ...
    return(
        <div>
            ...
            <CanvasDraw enablePanAndZoom = {false} clampLinesToDocument={true} imgSrc={props.URL} canvasHeight={800} canvasWidth={500} brushColor={"#FFFF0080"} catenaryColor={"#FFFF0080"}/>
        </div>
    )
}